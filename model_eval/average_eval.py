...
if __name__ == "__main__":
    ppo_average(output_file=os.path.join(base_dir,"logs", "PPO" , "averaged_evaluation_rand_env_seed10_100k_2.npz" ),base_log_dir=os.path.join(base_dir,"..", "PPO", "logs" , "eval", "batch_eval_100k_2"))
