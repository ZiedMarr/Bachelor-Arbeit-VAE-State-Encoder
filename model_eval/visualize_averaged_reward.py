...
def call_visualize_combined(vae_batch, vae_version, in_out , kl) :
    ...
    ppo_average_dir = os.path.join(base_dir, "logs", "PPO", "rand_env_1M")
...
if __name__ == "__main__" :
    ...
    #ppo_average_dir = os.path.join(base_dir, "logs", "PPO", "rand_env_1M")
    vae_ppo_notunings_average_dir = os.path.join("logs", "VAE_PPO", "V2.1", "rand_env_1M")
    ...
    vae_ppo_average(
        output_file=os.path.join(vae_ppo_average_dir, "batch_size_10_No_tunings.npz"),
        base_log_dir=os.path.join(base_dir, "..", "VAE_PPO_train", "logs", "batch_1M_no_tuning_VAE_Version_2.1_vae_random_100ep_config_A_2"))
    # Define file paths
    #ppo_file = os.path.join(ppo_average_dir, "batch_size_10.npz")
    vae_ppo_notunings_file = os.path.join(vae_ppo_notunings_average_dir, "batch_size_10_No_tunings.npz")
    vae_ppo_file = os.path.join(vae_ppo_average_dir, "batch_size_10.npz")
    visualize_combined_vaes(vae_ppo_notunings_file , vae_ppo_file, save=True)
