...
if __name__ == "__main__":
    ...
    vae_model_path = '../VAE_PPO_train/trained_vae/batch_1M_VAE_Version_2.1_vae_mix_10ep_config_K_2/500000_vae_mix_10ep_config_K_2_20250304_163819'

    ppo_model_batch = '../VAE_PPO_train/logs/batch_1M_VAE_Version_2.1_vae_mix_10ep_config_K_2'
    ...
    seed = 120
    save_path = os.path.join(".", "average_episodic_rewards", "4_2_K2")  # Directory to save results
    os.makedirs(save_path, exist_ok=True)
