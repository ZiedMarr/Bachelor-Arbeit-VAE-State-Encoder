...
if __name__ == "__main__":
    ...
    collect_from_batch(root_dir= os.path.join(base_dir,"..", "PPO","logs", "explore", "batch_10_100k"),output_path=os.path.join(base_dir,"collected_data", "train", "explore_pol_standard_env","ppo_100k_noise_0.5"), noise=True,noise_scale=0.5, num_episodes=10,env_wrapper=None)
    collect_from_batch(root_dir= os.path.join(base_dir,"..", "PPO","logs", "explore", "batch_10_200k"),output_path=os.path.join(base_dir,"collected_data", "train", "explore_pol_standard_env","ppo_200k_noise_0.5"), noise=True,noise_scale=0.5, num_episodes=10,env_wrapper=None)
