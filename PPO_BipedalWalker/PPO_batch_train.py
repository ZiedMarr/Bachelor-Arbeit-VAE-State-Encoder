import os
from PPO_BipedalWalker.train_ppo_BipedalWalker import train_ppo_cartpole
...
for i in range(batch_size):
    train_ppo_cartpole(log_batch_dir=log_batch_dir, total_timesteps=total_timesteps, seed=seeds[i], env_wrapper=RandomStartCartPoleEval)